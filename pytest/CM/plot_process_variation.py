...
file_path_1 = "/Users/sreyas/Documents/BTP_EE20B087/pytest/CM/process_gain_&_s11_vs_freq/gain_tt_lib.csv"
file_path_2 = "/Users/sreyas/Documents/BTP_EE20B087/pytest/CM/process_gain_&_s11_vs_freq/gain_ff_lib.csv"
file_path_3 = "/Users/sreyas/Documents/BTP_EE20B087/pytest/CM/process_gain_&_s11_vs_freq/gain_ss_lib.csv"
file_path_4 = "/Users/sreyas/Documents/BTP_EE20B087/pytest/CM/process_gain_&_s11_vs_freq/s11_tt_lib.csv"
file_path_5 = "/Users/sreyas/Documents/BTP_EE20B087/pytest/CM/process_gain_&_s11_vs_freq/s11_ff_lib.csv"
file_path_6 = "/Users/sreyas/Documents/BTP_EE20B087/pytest/CM/process_gain_&_s11_vs_freq/s11_ss_lib.csv"
...
ax.grid()
ax.legend(loc=0)
ax.set(xlim=(1e3, 10e6), ylim=(55, 65), yticks=np.linspace(55, 65, 11),
    xticks=np.array([1e3, 1e4, 1e5, 1e6, 1e7]), xlabel="Frequency (Hz)", ylabel="Trans-impedance Gain (in dB)", 
    title="Current Mode Passive Mixer: Variation of Gain vs Process Corners"
    )
plt.show()
fig, ax = plt.subplots()
...
ax.grid()
ax.legend(loc=0)
ax.set(xlim=(540e6, 560e6), ylim=(-7, -2), yticks=np.linspace(-7, -2, 11), 
    xticks=np.linspace(540e6, 560e6, 9), xlabel="Frequency (Hz)", ylabel="$S_{11}$ (in dB)", 
    title="Current Mode Passive Mixer: Variation of $S_{11}$ vs Process Corners"
    )
plt.show()
